...
//		}
	...
	public void func95Init() {
		if(myGame.currentPlayer.className.equals("Investigator") && checkHands(1)) {
			myGame.currentPlayer.hLevel += 1;
			myGame.currentPlayer.cLevel += 1;
		} else {
			System.out.println("You cannot play this item 95");
		}
	}
	
	public void func96Init() {
		//Gives you +1 to run away
		//Can wear with other headgear, but you lose it if you lose your headgear
	}
	
	public void func97Init(){
		if(!myGame.currentPlayer.className.equals("Monster Whacker") && checkHeadGear(1)) {
			myGame.currentPlayer.headLevel+=1;
			myGame.currentPlayer.cLevel+=3;
		} else {
			System.out.println("You cannot use this item 97");
			//myGame.mframe.mainPanel.bCardPanel.playerCLevel.setText("player clevel: "+myGame.currentPlayer.cLevel);
		}
	...
	public void func98Init() {
		if(checkHands(2)) {
			...
			System.out.println("You cannot use this item 98");
			//myGame.mframe.mainPanel.bCardPanel.playerCLevel.setText("player clevel: "+myGame.currentPlayer.cLevel);
		}
	}
	...
	public void func99Init() {
		if(checkFootLevel(1)) {
			...
			//Technically this can be worn over footgear
			System.out.println("You cannot use this item 99");
			//myGame.mframe.mainPanel.bCardPanel.playerCLevel.setText("player clevel: "+myGame.currentPlayer.cLevel);
		}
	}
