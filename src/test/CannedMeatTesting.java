...
import munchkin.cards.treasures.CannedMeat;
 ...
 */
public class CannedMeatTesting {
	private Treasure treasure;
	private Game game;
	@Before
	public void setUp() {
		this.game = new Game(2);
		this.treasure = new CannedMeat(game);		
	...
	public void playCard(){
		...
		assertEquals(3, this.treasure.getBonus());
		assertEquals(100, this.treasure.getGold());
	}
