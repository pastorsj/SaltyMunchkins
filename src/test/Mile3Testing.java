...
public class Mile3Testing {
	...
	@Test
	public void setValuesForC148() {
		assertEquals(400, init.cardHash.get(148).numGold);
		assertEquals(3, init.cardHash.get(148).pLevelBonus);
		assertEquals(1, init.cardHash.get(148).numHands);
	}
}
