...
//		cardHash.get(85).numGold = 600;
		...
		cardHash.get(87).discard = false;
		cardHash.get(88).numGold = 300;
		cardHash.get(87).numHands=-1;
		...
		cardHash.get(96).headGear = true;
		cardHash.get(96).numGold=200;
		cardHash.get(96).discard=false;
